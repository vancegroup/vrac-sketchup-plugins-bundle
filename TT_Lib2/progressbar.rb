...
class TT::Progressbar
  ...
  #   progress.next
  #  }
  #  Sketchup.status_text = "Something took #{process.estimated_time(true)} to complete."
	#
	...
	# @param [Integer] decimals Number of decimals for the percentage in the statusbar.
	#
	# @since 2.5.0
