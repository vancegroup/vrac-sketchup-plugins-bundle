...
module TT::Edges
  ...
  def self.repair_splits( entities, progress_in_ui=false )
    ...
    # This method makes temporary edges which should not be split - so the Break Edges feature
    # in SU7+ is disabled for the duration of this method. (?) Is it really needed?
    break_edge = Sketchup.break_edges?
    ...
    # Restore the break_edges setting
    Sketchup.break_edges = break_edge
    return temp_edges.size
  end
